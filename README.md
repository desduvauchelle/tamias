...
- [] Add memory logic (update user/robot/memories), chat session length management (auto-summarize after 20 chats, and include summary in conversation memory instead of all the history, this should auto update memory files and conversation files)
